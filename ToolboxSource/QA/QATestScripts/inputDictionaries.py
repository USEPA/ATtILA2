...
class LCP_options: 
    testInputs = {
        ...
        'metricsToRun' : ["for  -  [pfor]  Forest';'wtlw  -  [pwtlw]  Woody Wetland';'UI  -  [UINDEX]  All Human Land Use",
...
class LCD_options: 
    testInputs = {
        ...
        'inLandCoverGrid' : [rasters.NLCD_2011],
        'processingCellSize' : ['30'],
        'optionalFieldGroups' : [ " ",
                                "'LOGFILE  -  Record Process Steps Taken During Metric Calculation'", 
                                 "'INTERMEDIATES  -  Retain Intermediate Layers Generated During Metric Calculation'", 
...
class FLCV_options: 
    ...
    'reportingUnitIdField' : ['HUC_12'], 
    'inLandCoverGrid' : [rasters.NLCD_2016],
    'metricsToRun' : ["for  -  [for_Low]  Forest';'agr  -  [agr_Low]  Agriculture"],
...
class PLCV_options: 
    ...
    'reportingUnitIdField' : ['HUC_12'], 
    'inLandCoverGrid' : [rasters.NLCD_2016], 
    'metricsToRun' : ["for  -  [for_PV_C]  Forest';'agr  -  [agr_PV_C]  Agriculture"], 
    'View_radius' : ["9"], 
...
class CWCR_options: 
    testInputs = {
        ...
        'Impassable_features' : [("{0};{1}".format(lines.Roads_NonWalkable, lines.Stream_Lines, polygons.Stream_Polygons)), lines.Roads_NonWalkable], 
        'Maximum_travel_distance':["800"], 
        'Walk_value' : ["1"], 
        'Base_value' : ["10"], 
        'Density_raster_cell_size' : ["10"], 
...
class SZS_options: 
    ...
    'inReportingUnitFeature' : [polygons.Watersheds],
    'reportingUnitIdField' : ['HUC_12'],
    'Input_value_raster' : [rasters.Slope], 
