...
def runTest():
    try:
        ...
        arcpy.AddMessage "Running Core Edge calculation"
...
#        arcpy.AddMessage "Testing RiparianLandCoverProportions results"
...
def runTableTest():
    ...
    try:
        if arcpy.Exists(p.outTable):
            arcpy.Delete_management(p.outTable)
        arcpy.AddMessage "Running Table Test calculation"
        ...
        arcpy.AddMessage metricsFieldnameDict  
