...
paramCombosList = list(itertools.product(*PLCV_options.testInputs.values()))
...
for iteration, params in enumerate(paramCombosList): 
  paramDict = dict(zip(PLCV_options.testInputs.keys(), params))
