AttrDict = { 
    ...
    #Riparian Land Cover Proportions
        ...
        'rUI': 'All Human Land Useusing a {dist} buffer',
    ...
    #Land Cover Proportions
        ...
        'pwtl': 'Wetland', 
        'pwtlw': 'Woody Wetland', 
        'pwtle': 'Emergent Wetland', 
        'UINDEX': 'All Human Land Use', 
        'pdev': 'Developed', 
        'pdevo': 'Open Space Developed',
        'pdevl': 'Low Intensity Developed',
        'pdevm': 'Medium Intensity Developed',
        'pdevh': 'High Intensity Developed', 
        'pagr': 'Agriculture',
        'pagrp': 'Pasture/Hay', 
        'pagrc': 'Cultivated Crop', 
