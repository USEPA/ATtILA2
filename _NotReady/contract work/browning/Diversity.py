...
try:
    ...
    tmpFile = "C:/Documents and Settings/aeerdheim/My Documents/ATtILA2/diversityscript/testdata/output/temp.dbf"
    ...
    arcpy.AddField_management(outFile, "LC_Overlap", "DOUBLE")
    arcpy.AddField_management(outFile, "S", "DOUBLE")
    arcpy.AddField_management(outFile, "H", "DOUBLE")
    arcpy.AddField_management(outFile, "H_Prime", "DOUBLE")
    arcpy.AddField_management(outFile, "C", "DOUBLE")

    # Set environemnt output coordinates var to HUC file so we know we get sq meters
...
##
##    # Create a list containing polygon sq meters values
##    outrows = arcpy.SearchCursor(outFile)
##    sqmeterslist = []
##    for outrow in outrows:
##        sqmeterslist.append(outrow.shape.Area)
##
##    # Delete cursor
##    if outrow:
##        del outrow
